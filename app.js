...
function productionPrompt(){return `צרי עכשיו שיר סיום למפגש הפתוח לקהל הרחב ״תשובה פנימה״ של קרן בן עמי, מתוך שורות המקור בהמשך. זהו שיר שנוצר בזמן המפגש כדי שנוכל להקשיב לו יחד בסופו. השיר יישלח למשתתפות בתום המפגש.
