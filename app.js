...
function productionPrompt(){return `צרי עכשיו שיר סיום למפגש הקהילה ״תשובה פנימה״ של קרן בן עמי, מתוך שורות המקור בהמשך. זהו שיר שנוצר בזמן המפגש כדי שנוכל להקשיב לו יחד בסופו.
...
השפה של בין לבין: קול נשי קרוב ואנושי, נשימה וגרעיניות, סול עם גוון תפילה מזרחי, כלי נשיפה נמוך שעונה בין משפטים, סאבטקסט ומילים שאפשר לומר בפה. הפעם לפי בחירת קרן: איטי מאוד, עדין ושקט, 60 עד 64 BPM, ארבע עד חמש דקות. התנועה היא בקִרבה, במרווחים ובהצטמצמות הליווי. ללא שיא ריקודי, מקהלה מנופחת, דרופ או עצירה מבהילה. לפתוח בקול קרוב, להרחיב מעט, לחזור לשקט ולהשאיר עשר שניות נשימה בסוף.
