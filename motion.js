...
(()=>{const stamp=document.createElement("p");stamp.className="small";stamp.textContent="גרסה 25 · ניקוד חי · ללא שעת חזרה קבועה";document.getElementById("tools").append(stamp)})();
